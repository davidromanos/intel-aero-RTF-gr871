...
extern void ekf(uint8_T fastslam_on, real_T fastslam[6], real_T C_fs[36], real_T
                imu[2], real_T roll_ref, real_T pitch_ref, real_T yaw_ref,
                real_T thrust_ref, real_T est[16]);
extern void ekf_api(const mxArray * const prhs[8], const mxArray *plhs[1]);
