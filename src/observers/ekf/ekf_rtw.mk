...
## 
## Makefile     : ekf_rtw.mk
## Generated on : Tue May 23 10:38:10 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ekf.a
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ekf.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/ekf -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=ekf -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
%.o : $(START_DIR)/codegen/lib/ekf/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/ekf/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
