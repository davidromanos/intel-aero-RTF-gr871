 ...
 * Return Type  : void
 */
void ekfnobias_api(const mxArray *prhs[8], const mxArray *plhs[3])
{
  real_T (*est)[17];
  real_T (*Pout)[9];
  uint8_T fastslam_on;
  ...
  real_T thrust_ref;
  real_T VarYaw;
  est = (real_T (*)[17])mxMalloc(sizeof(real_T [17]));
  ...
  ekfnobias(fastslam_on, *fastslam, *C_fs, *PX4, roll_ref, pitch_ref, yaw_ref,
 ...
 * Return Type  : void
 */
void ekfnobias_atexit(void)
{
  mexFunctionCreateRootTLS();
  emlrtEnterRtStackR2012b(emlrtRootTLSGlobal);
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
  ekfnobias_xil_terminate();
}
 ...
 * Return Type  : void
 */
void ekfnobias_initialize(void)
{
  mexFunctionCreateRootTLS();
...
/*
 * File trailer for _coder_ekfnobias_api.c
 *
 * [EOF]
 */
